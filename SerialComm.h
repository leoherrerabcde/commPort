...
#define MAXROWS         1/*JVM OJO*/
#define MAXCOLS         1

#define MAXBLOCK        512 /*JVM OJO solo un caracter por vez*/

#define MAXLEN_TEMPSTR  81

#define RXQUEUE         1024	/*JVM*/
#define TXQUEUE         1024
...
typedef struct tagTTYINFO
{
   ...
   DWORD   dwBaudRate ;
   //JVM WORD    wCursorState ;
   //JVM HFONT   hTTYFont ;
   //JVM LOGFONT lfTTYFont ;
   //JVM DWORD   rgbFGColor ;
   /*int     xSize, ySize, xScroll, yScroll, xOffset, yOffset,
           nColumn, nRow, xChar, yChar ; JVM */
...
// JVM #define GETHINST( x )  ((HINSTANCE) GetWindowLong( x, GWL_HINSTANCE ))
//#define GETNPTTYINFO( x ) (x = gnpTTYINFO)
//#define GETNPTTYINFO( x ) ((NPTTYINFO) GetWindowLong( x, GWL_NPTTYINFO ))
//#define SETNPTTYINFO( x, y ) (gnpTTYINFO = y )

#define GETNPTTYINFO	( gnpTTYINFO)
#define SETNPTTYINFO( y ) (gnpTTYINFO = y )
...
void NEAR interrupcion_serial(BYTE aSFBRI,BYTE * aSBUF, BYTE aSFBTI); /*SIM JVM*/
